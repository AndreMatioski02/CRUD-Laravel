        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Preço:')) !!}
                        {!! Form::number("precoVenda", $produto->precoVenda ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>
                    ...
                    <div class="form-group">
                        {!! Form::label(__('Peso:')) !!}
                        {!! Form::number("peso", $produto->peso ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>

                    <div class="form-group">
                        {!! Form::label(__('Descrição:')) !!}
                        {!! Form::text("descricao", $produto->descricao ,["class"=>"form-control","required"=>"required"]) !!}
                    </div>
